...
@Component({
  selector: 'app-etat-paiement-vente-edit-admin',
  templateUrl: './etat-paiement-vente-edit-admin.component.html'
})
export class EtatPaiementVenteEditAdminComponent extends AbstractEditController<EtatPaiementVenteDto, EtatPaiementVenteCriteria, EtatPaiementVenteService>   implements OnInit {
