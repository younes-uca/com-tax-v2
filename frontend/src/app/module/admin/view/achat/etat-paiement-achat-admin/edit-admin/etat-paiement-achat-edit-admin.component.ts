...
@Component({
  selector: 'app-etat-paiement-achat-edit-admin',
  templateUrl: './etat-paiement-achat-edit-admin.component.html'
})
export class EtatPaiementAchatEditAdminComponent extends AbstractEditController<EtatPaiementAchatDto, EtatPaiementAchatCriteria, EtatPaiementAchatService>   implements OnInit {
