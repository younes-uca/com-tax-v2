...
export class ReceptionEditAdminComponent extends AbstractEditController<ReceptionDto, ReceptionCriteria, ReceptionService>   implements OnInit {
    ...
    constructor( private receptionService: ReceptionService , private commandeService: CommandeService, private etatReceptionService: EtatReceptionService, private receptionItemService: ReceptionItemService, private magasinService: MagasinService, private produitService: ProduitService) {
