...
export class CommandeListAdminComponent extends AbstractListController<CommandeDto, CommandeCriteria, CommandeService>  implements OnInit {
    ...
    constructor(commandeService: CommandeService, private clientService: ClientService, private storeService: StoreService, private etatCommandeService: EtatCommandeService) {
