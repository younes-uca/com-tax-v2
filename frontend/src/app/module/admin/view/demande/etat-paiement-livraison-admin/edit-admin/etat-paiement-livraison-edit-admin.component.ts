...
@Component({
  selector: 'app-etat-paiement-livraison-edit-admin',
  templateUrl: './etat-paiement-livraison-edit-admin.component.html'
})
export class EtatPaiementLivraisonEditAdminComponent extends AbstractEditController<EtatPaiementLivraisonDto, EtatPaiementLivraisonCriteria, EtatPaiementLivraisonService>   implements OnInit {
